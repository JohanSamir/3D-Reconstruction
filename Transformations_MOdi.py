...
T1_2F = T1_2* T0_1 
T2_3F = T2_3 * T1_2* T0_1 
T3_4F = T3_4 * T2_3 * T1_2* T0_1 
T4_5F = T4_5 * T3_4 * T2_3 * T1_2* T0_1 
T5_6F = T5_6 * T4_5 * T3_4 * T2_3 * T1_2* T0_1 
...
np.savetxt('Dataset_pcd/FinalPoint_Good.csv', c)
