...
class synchronizer:
	...
	def callback(self):
		...
		lidarPC2 = pc2.read_points(self.pc_sub)
		lidar = np.array(list(lidarPC2))
		lidarPointsXYZ = lidar[:,0:3]
		np.savetxt("/home/johan/Documents/Alignment/Points_csv_kiity/"+nombre_pointcsv+".csv",lidarPointsXYZ, header='x,y,z', comments='')
		#pcd = opn3.PointCloud()
